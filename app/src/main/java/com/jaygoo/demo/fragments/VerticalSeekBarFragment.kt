...
class VerticalSeekBarFragment : BaseFragment() {
    ...
    override fun initView(view: View) {
        ...
        view.findViewById<RangeSeekBar>(R.id.sb_vertical_3)?.setIndicatorTextDecimalFormat("0")
        view.findViewById<RangeSeekBar>(R.id.sb_vertical_4)?.run {
            setIndicatorTextDecimalFormat("0")
            setIndicatorTextStringFormat("%s%%")
            setProgress(30f, 60.6f)
        }

        view.findViewById<RangeSeekBar>(R.id.sb_vertical_6)?.setProgress(30f)

        view.findViewById<RangeSeekBar>(R.id.sb_vertical_7)?.setProgress(40f, 80f)

        view.findViewById<RangeSeekBar>(R.id.sb_vertical_8)?.setIndicatorTextDecimalFormat("0.0")
