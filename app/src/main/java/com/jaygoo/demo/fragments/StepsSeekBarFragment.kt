...
class StepsSeekBarFragment : BaseFragment() {
    ...
    override fun initView(view: View) {
        ...
        view.findViewById<RangeSeekBar>(R.id.sb_steps_1)?.setStepsDrawable(stepsDrawables)
        view.findViewById<RangeSeekBar>(R.id.sb_steps_2)?.setStepsDrawable(stepsDrawables)
    }
